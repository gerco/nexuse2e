...
<html:form action="ProcessConversationReport.do">
        ...
        <table class="NEXUS_TABLE" width="100%" style="margin-bottom: 0pt;">
            <tr>
              <td class="NEXUSValue">Search for</td>
                <td class="NEXUSValue">
                  <html:radio styleId="convSearch" onclick="javascript: scriptScope.disableLinks(); scriptScope.searchForConversations();" property="searchFor" value="conversation"/>Conversations&nbsp;&nbsp;&nbsp;<html:radio onclick="javascript: scriptScope.disableLinks(); scriptScope.searchForMessages();" property="searchFor" value="message"/>Messages 
                </td>
                
                <td class="NEXUSValue">Choreography ID</td>                 
                <td class="NEXUSValue">
                  <html:select onchange="javascript: scriptScope.disableLinks();" styleClass="fixedsize" property="choreographyId">
                    <html-el:option value=""/>
                    <logic:notEmpty name="reportingPropertiesForm" property="choreographyIds">
                      <logic:iterate id="choreographies" name="reportingPropertiesForm" property="choreographyIds">
            ...
            <tr>
                ...
                <td class="NEXUSValue">
                  <html:select onchange="javascript: scriptScope.disableLinks();" styleClass="fixedsize" property="participantId">
                    <html-el:option value=""/>
                    <logic:notEmpty name="reportingPropertiesForm" property="participantIds">
                      <logic:iterate id="participants" name="reportingPropertiesForm" property="participantIds">
                        <html-el:option value="${participants}"/>
                      </logic:iterate>
                    </logic:notEmpty>
                  </html:select>
                </td>
                <td class="NEXUSValue">Conversation ID <html:checkbox onchange="javascript: scriptScope.disableLinks();" name="reportingPropertiesForm" property="conversationEnabled"/></td>
                <td class="NEXUSValue">
                <html:text onchange="javascript: scriptScope.disableLinks();" styleClass="fixedsize" property="conversationId"></html:text></td>
            </tr>
            ...
            <tr>
                ...
                <td id="messageIdText" class="NEXUSValue">Message ID<html:checkbox onchange="javascript: scriptScope.disableLinks();" name="reportingPropertiesForm" property="messageEnabled"/></td>
                <td class="NEXUSValue">
                <html:text onchange="javascript: scriptScope.disableLinks();" styleClass="fixedsize" property="messageId"></html:text></td>
            </tr>
            
            <tr>
                <td class="NEXUSValue">Start Date <html:checkbox onchange="scriptScope.disableLinks();" name="reportingPropertiesForm" property="startEnabled"/></td>
              ...
              <td class="NEXUSValue">End Date <html:checkbox onchange="javascript: scriptScope.disableLinks();" name="reportingPropertiesForm" property="endEnabled"/></td>
                <td class="NEXUSValue" align="left">
        ...
        <table class="NEXUS_BUTTON_TABLE" width="100%">
            <tr>                
                ...
                |
                <logic:equal name="reportingPropertiesForm" property="prevActive" value="true"><nexus:submit id="previousLink" onClick="document.forms['reportingPropertiesForm'].command.value='back';" styleClass="NexusLink">Previous</nexus:submit></logic:equal>
                ...
                <logic:equal name="reportingPropertiesForm" property="nextActive" value="true"><nexus:submit id="nextLink" onClick="document.forms['reportingPropertiesForm'].command.value='next';" styleClass="NexusLink">Next</nexus:submit></logic:equal>
...
<logic:equal name="reportingPropertiesForm" property="searchFor" value="message">
  ...
  <logic:notEmpty name="collection">
    <table class="NEXUS_TABLE" width="100%">
          <tr> 
              <logic:equal name="reportingPropertiesForm" property="messColSelect" value="true"><th class="NEXUSSection" ></th></logic:equal>
              <th class="NEXUSSection">Message ID</th>
              <logic:equal name="reportingPropertiesForm" property="messColParticipantId" value="true"><th class="NEXUSSection">Participant ID</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColStatus" value="true"><th class="NEXUSSection">Status</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColType" value="true"><th class="NEXUSSection">Message Type</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColAction" value="true"><th class="NEXUSSection">Action</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColCreated" value="true"><th class="NEXUSSection">Date Created</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColTurnaround" value="true"><th class="NEXUSSection">Turnaround Time</th></logic:equal>
          </tr>
      <logic:iterate indexId="counter" id="message" name="collection">
          <tr>                  
          
              <logic:equal name="reportingPropertiesForm" property="messColSelect" value="true"><td class="NEXUSValue"><html-el:multibox name="reportingPropertiesForm" property="selected" value="${message.participantId}|${message.choreographyId}|${message.conversationId}|${message.messageId}"/></td></logic:equal>
              <td class="NEXUSValue"><nexus:link href="MessageView.do?mId=${message.messageId}&convId=${message.conversationId}&chorId=${message.choreographyId}&partnerId=${message.participantId}"><bean:write name="message" property="messageId"/></nexus:link></td>
              <logic:equal name="reportingPropertiesForm" property="messColParticipantId" value="true"><td class="NEXUSValue"><bean:write name="message" property="participantId"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColStatus" value="true"><td class="NEXUSValue"><bean:write name="message" property="status"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColType" value="true"><td class="NEXUSValue"><bean:write name="message" property="type"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColAction" value="true"><td class="NEXUSValue"><bean:write name="message" property="action"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColCreated" value="true"><td class="NEXUSValue"><bean:write name="message" property="createdDate"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="messColTurnaround" value="true"><td class="NEXUSValue"><bean:write name="message" property="turnaroundTime"/></td></logic:equal>
          </tr>
      </logic:iterate>
    </table>
    <logic:equal name="reportingPropertiesForm" property="messColSelect" value="true">
    <table class="NEXUS_BUTTON_TABLE" width="100%">
        <tr>                
          <td class="BUTTON_LEFT"><a href="#" id="startLink" onclick="javascript: scriptScope.selectAll(true);" class="NexusLink" styleClass="white-space:nowrap;">Select all</a></td>
            <td class="BUTTON_LEFT"><a href="#" id="startLink" onclick="javascript: scriptScope.selectAll(false);" class="NexusLink" styleClass="white-space:nowrap;">Deselect all</a></td>
            <td class="BUTTON_RIGHT"><nexus:submit onClick="document.forms['reportingPropertiesForm'].command.value='requeue';"><img src="images/submit.gif" name="clearButton"></nexus:submit></td>
            <td class="NexusHeaderLink">Re-Queue</td>
            <td class="BUTTON_RIGHT"><nexus:submit onClick="document.forms['reportingPropertiesForm'].command.value='stop';"><img src="images/reset.gif" name="clearButton"></nexus:submit></td>
...
<logic:notEqual name="reportingPropertiesForm" property="searchFor" value="message">
  <logic:notEmpty name="collection">
    <table class="NEXUS_TABLE" width="100%">
          <tr>
            <logic:equal name="reportingPropertiesForm" property="convColSelect" value="true"><th class="NEXUSSection"></th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColChorId" value="true"><th class="NEXUSSection">Choreography ID</th></logic:equal>
              <th class="NEXUSSection">Conversation ID</th>
              <logic:equal name="reportingPropertiesForm" property="convColPartId" value="true"><th class="NEXUSSection">Participant ID</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColStatus" value="true"><th class="NEXUSSection">Status</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColAction" value="true"><th class="NEXUSSection">Current Action</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColCreated" value="true"><th class="NEXUSSection">Date Created</th></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColTurnaround" value="true"><th class="NEXUSSection">Turnaround Time</th></logic:equal>
          </tr>
      <logic:iterate indexId="counter" id="conv" name="collection">
          <tr>                  
              <logic:equal name="reportingPropertiesForm" property="convColSelect" value="true"><td class="NEXUSValue"><html-el:multibox name="reportingPropertiesForm" property="selected" value="${conv.participantId}|${conv.choreographyId}|${conv.conversationId}"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColChorId" value="true"><td class="NEXUSValue"><bean:write name="conv" property="choreographyId"/></td></logic:equal>
              <td class="NEXUSValue"><nexus:link href="ConversationView.do?convId=${conv.conversationId}&choreographyId=${conv.choreographyId}&partnerId=${conv.participantId}"><bean:write name="conv" property="conversationId"/></nexus:link></td>
              <logic:equal name="reportingPropertiesForm" property="convColPartId" value="true"><td class="NEXUSValue"><bean:write name="conv" property="participantId"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColStatus" value="true"><td class="NEXUSValue"><bean:write name="conv" property="status"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColAction" value="true"><td class="NEXUSValue"><bean:write name="conv" property="action"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColCreated" value="true"><td class="NEXUSValue"><bean:write name="conv" property="createdDate"/></td></logic:equal>
              <logic:equal name="reportingPropertiesForm" property="convColTurnaround" value="true"><td class="NEXUSValue"><bean:write name="conv" property="turnaroundTime"/></td></logic:equal>
          </tr>
      </logic:iterate>
    </table>
