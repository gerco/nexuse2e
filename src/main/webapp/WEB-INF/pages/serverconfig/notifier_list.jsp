...
<nexus:helpBar helpDoc="documentation/Notifier_Listing.htm"/>
    ...
    <table class="NEXUS_TABLE" width="100%">
      ...
      <logic:iterate id="notifier" name="collection"> 
        <tr>
          <td class="NEXUSValue">
            <nexus:link href="NotifierView.do?nxLoggerId=${notifier.nxLoggerId}" styleClass="NexusLink">
              <bean:write name="notifier" property="name"/>
            </nexus:link>
          </td>
          <td class="NEXUSValue">
            <bean:write name="notifier" property="filterString"/>
          </td>
          <td class="NEXUSValue">
            <bean:write name="notifier" property="autoStartString"/>
          </td>
          <td class="NEXUSValue">
            <bean:write name="notifier" property="runningString"/>
          </td>
        </tr>
      </logic:iterate>
      ...
      <table class="NEXUS_BUTTON_TABLE">
        <tr>
	        ...
	        <td class="NexusHeaderLink" style="text-align: right;">
				    <nexus:link href="NotifierAdd.do?nxComponentId=0" styleClass="button"><img src="images/tree/plus.gif" class="button">Add Notifier</nexus:link>
    			</td>
      	</tr>
      </table>
  </center>
