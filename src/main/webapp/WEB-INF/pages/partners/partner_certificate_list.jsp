...
<nexus:helpBar helpDoc="documentation/Collaboration_Partners.htm"/>
    ...
    <table class="NEXUS_TAB_TABLE">
        <tr>
            ...
            <td class="NEXUS_TAB_LEFT_UNSELECTED"><img src="images/left666666.gif"></td>
            <td class="NEXUS_TAB_UNSELECTED"><nexus:link href="PartnerConnectionList.do?nxPartnerId=${collaborationPartnerForm.nxPartnerId}" styleClass="NEXUS_TAB_UNSELECTED_LINK">Connections</nexus:link></td>
            <td class="NEXUS_TAB_RIGHT_UNSELECTED"><img src="images/right666666.gif"></td>
    ...
    <table class="NEXUS_TABLE" width="100%">
        ...
        <logic:iterate id="cert" name="collaborationPartnerForm" property="certificates"> 
        <tr>
            <td class="NEXUSValue"><nexus:link href="PartnerCertificateView.do?nxPartnerId=${collaborationPartnerForm.nxPartnerId}&nxCertificateId=${cert.nxCertificateId}" styleClass="NexusLink">
            <bean:write name="cert" property="id"/></nexus:link></td>
            ...
            <td class="NEXUSValue">
            <logic:equal name="cert" property="validity" value="Okay">
          <font color="green"><b><bean:write name="cert" property="validity"/></b></font> <bean:write name="cert" property="remaining"/>
        </logic:equal>
        <logic:notEqual name="cert" property="validity" value="Okay">
          <font color="red"><b><bean:write name="cert" property="validity"/></b></font>
        </logic:notEqual>
        </td>
        </tr>
        </logic:iterate>
    ...
    <table class="NEXUS_BUTTON_TABLE">
      <tr>
        ...
        <td class="NexusHeaderLink" style="text-align: right;">
          <nexus:link href="PartnerCertificateAdd.do?partnerId=${collaborationPartnerForm.partnerId}" styleClass="button"><img src="images/tree/plus.gif" class="button">Add Certificate</nexus:link>
        </td>
      </tr>
    </table>
