...
public class FtpSavePipelet extends AbstractPipelet {
    ...
    public FtpSavePipelet() {
        ...
        parameterMap.put( FILE_PATTERN_PARAM_NAME, new ParameterDescriptor( ParameterType.STRING, "File name pattern",
                "Pattern for uploaded file name. Variable expressions allowed.",
                "${nexus.message.partnerid}_${nexus.message.createdDate}.xml" ) );
    ...
    private String writePayload(
            FTPClient ftp, String fileNamePattern, MessagePayloadPojo payload, MessageContext messageContext )
