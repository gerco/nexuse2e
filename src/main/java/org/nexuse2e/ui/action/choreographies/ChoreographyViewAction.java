 ...
 */
public class ChoreographyViewAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        if ( ( nxChoreographyId == 0 ) && ( ( choreographyId == null ) || ( choreographyId.length() == 0 ) ) ) {
            ActionMessage errorMessage = new ActionMessage( "generic.error", "Invalid or empty ChoreographyId!" );
        ...
        if ( choreographyPojo != null ) {
            form.setActions( new Vector( choreographyPojo.getActions() ) );
            form.setParticipants( new Vector( choreographyPojo.getParticipants() ) );
