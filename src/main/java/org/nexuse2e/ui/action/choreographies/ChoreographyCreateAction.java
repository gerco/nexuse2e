 ...
 */
public class ChoreographyCreateAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        ChoreographyPojo choreography = new ChoreographyPojo();
        choreography.setName( form.getChoreographyName() );
        choreography.setDescription( form.getDescription() );
