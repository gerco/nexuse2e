...
public class ServiceDeleteAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        ServicePojo service = Engine.getInstance().getActiveConfigurationAccessService().getServicePojoByNxServiceId(
                serviceForm.getNxServiceId() );
        if ( service != null ) {
            Engine.getInstance().getActiveConfigurationAccessService().deleteService( service );
        }
