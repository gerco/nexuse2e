...
public class SaveConfigFieldsAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        parameterMap.put( "pagesize", new ParameterDescriptor( ParameterType.STRING, "itemcount", "items per page",
                "20" ) );
        parameterMap.put( "timezone", new ParameterDescriptor( ParameterType.STRING, "itemcount", "items per page",
                "20" ) );
