 ...
 *
 */
public class CACertAddAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        //request.getSession().setAttribute( Crumbs.CURRENT_LOCATION, Crumbs.CA_ADD_CERT );

        LOG.debug( "add single cert..." );
