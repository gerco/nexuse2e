 ...
 * @date 04.01.2007
 */
public class UserDeleteAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        if ( user != null ) {
            ...
            errors.add( ActionMessages.GLOBAL_MESSAGE, new ActionMessage( "nexususer.error.notFound" ) );
        }
        
        return  ( errors.size() == 0 ? actionMapping.findForward( ACTION_FORWARD_SUCCESS ) : actionMapping.findForward( ACTION_FORWARD_FAILURE ) );
    }
