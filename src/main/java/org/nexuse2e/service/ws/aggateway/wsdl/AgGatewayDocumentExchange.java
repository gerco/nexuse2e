...
@WebServiceClient(name = "AgGatewayDocumentExchange", 
                  wsdlLocation = "file:/Volumes/NexusE2E/nexuse2e-server-sf/src/main/resources/org/nexuse2e/integration/AgGateway.wsdl",
...
public class AgGatewayDocumentExchange extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Volumes/NexusE2E/nexuse2e-server-sf/src/main/resources/org/nexuse2e/integration/AgGateway.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/Volumes/NexusE2E/nexuse2e-server-sf/src/main/resources/org/nexuse2e/integration/AgGateway.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
