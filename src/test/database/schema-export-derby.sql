...
create table nx_action (nx_action_id integer not null, nx_choreography_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, start_flag integer not null, end_flag integer not null, inbound_nx_pipeline_id integer not null, outbound_nx_pipeline_id integer not null, name varchar(64) not null, primary key (nx_action_id));
...
create table nx_choreography (nx_choreography_id integer not null, description varchar(64), name varchar(64), created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, primary key (nx_choreography_id));
...
create table nx_logger (nx_logger_id integer not null, nx_component_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, name varchar(64) not null, autostart_flag integer not null, threshold integer not null, filter varchar(4098) not null, description varchar(64), primary key (nx_logger_id));
...
create table nx_logger_param (nx_logger_param_id integer not null, nx_logger_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, label varchar(64), value varchar(64) not null, sequence_number integer, primary key (nx_logger_param_id));
...
create table nx_message_label (nx_message_label_id integer not null, nx_message_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, label varchar(64), value varchar(512) not null, primary key (nx_message_label_id));
...
comment on column nx_message_label.label is '';
comment on column nx_message_label.value is '';
...
create table nx_pipelet_param (nx_pipelet_param_id integer not null, nx_pipelet_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, label varchar(64), value varchar(64) not null, sequence_number integer, primary key (nx_pipelet_param_id));
...
comment on column nx_pipelet_param.label is '';
comment on column nx_pipelet_param.value is '';
comment on column nx_pipelet_param.sequence_number is '';
create table nx_pipeline (nx_pipeline_id integer not null, direction_flag integer not null, frontend_flag integer not null, manual_flag integer not null, timer_flag integer not null, timer_interval integer, nx_trp_id integer, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, description varchar(64), name varchar(64) not null, primary key (nx_pipeline_id));
...
comment on column nx_pipeline.manual_flag is '';
comment on column nx_pipeline.timer_flag is '';
comment on column nx_pipeline.timer_interval is '';
...
create table nx_service_param (nx_service_param_id integer not null, nx_service_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, label varchar(64), value varchar(64) not null, sequence_number integer, primary key (nx_service_param_id));
...
comment on column nx_service_param.label is '';
comment on column nx_service_param.value is '';
