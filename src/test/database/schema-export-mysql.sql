...
create table nx_choreography (nx_choreography_id integer not null auto_increment, description varchar(64) comment '', name varchar(64) not null unique comment '', created_date datetime not null comment '', modified_date datetime not null comment '', modified_nx_user_id integer not null comment '', primary key (nx_choreography_id)) comment='';
