 ...
 * 
 */
public class CACertMissingAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response,
        ...
        LOG.debug("CACertMissingAction: User imported certificate but we could not construct the trust chain, showing explanation screen.");
