...
public class PartnerAddAction extends NexusE2EAction {
    ...
    public ActionForward executeNexusE2EAction( ActionMapping actionMapping, ActionForm actionForm,
        ...
        if ( type.equals( "1" ) ) {
            //request.getSession().setAttribute( Crumbs.CURRENT_LOCATION, Crumbs.LOCAL_PARTNER_ADD );
            form.setType( 1 );
        } else {
            //request.getSession().setAttribute( Crumbs.CURRENT_LOCATION, Crumbs.PARTNER_ADD );
            form.setType( 2 );
        }
