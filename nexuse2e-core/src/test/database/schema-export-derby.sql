...
--
alter table nx_action drop constraint fk__action__status_update_pipeline_id;
...
create table nx_action (nx_action_id integer not null, nx_choreography_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, start_flag smallint not null, end_flag smallint not null, inbound_nx_pipeline_id integer not null, outbound_nx_pipeline_id integer not null, status_update_nx_pipeline_id integer, name varchar(64) not null, primary key (nx_action_id));
...
create table nx_certificate (nx_certificate_id integer not null, type integer not null, password varchar(64), created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, nx_partner_id integer, name varchar(512) not null, description varchar(256), binary_data blob(128000), primary key (nx_certificate_id));
...
create table nx_generic_param (nx_generic_param_id integer not null, category varchar(128) not null, param_tag varchar(128), created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, param_label varchar(64), param_value varchar(1024), sequence_number integer, primary key (nx_generic_param_id));
...
create table nx_log (nx_log_id integer not null, log_id varchar(255) not null, class_name varchar(255) not null, method_name varchar(255) not null, event_id integer not null, severity integer not null, conversation_id varchar(96) not null, message_id varchar(96) not null, description varchar(255) not null, created_date timestamp not null, primary key (nx_log_id));
...
create table nx_logger_param (nx_logger_param_id integer not null, nx_logger_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, param_label varchar(64), param_value varchar(1024), sequence_number integer, primary key (nx_logger_param_id));
...
create table nx_mapping (nx_mapping_id integer not null, category varchar(128) not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, left_type integer not null, left_value varchar(128), right_type integer not null, right_value varchar(128), primary key (nx_mapping_id));
...
create table nx_message (nx_message_id integer not null, nx_conversation_id integer not null, message_id varchar(96) not null, header_data blob(128000), type integer not null, nx_action_id integer not null, status integer not null, nx_trp_id integer, referenced_nx_message_id integer, retries integer not null, direction_flag smallint not null, expiration_date timestamp, end_date timestamp, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, primary key (nx_message_id));
...
create table nx_message_payload (nx_message_payload_id integer not null, nx_message_id integer not null, sequence_number integer not null, mime_type varchar(64) not null, content_id varchar(96) not null, payload_data blob(8000000) not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, primary key (nx_message_payload_id));
...
create table nx_pipelet_param (nx_pipelet_param_id integer not null, nx_pipelet_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, param_label varchar(64), param_value varchar(1024), sequence_number integer, primary key (nx_pipelet_param_id));
...
create table nx_service (nx_service_id integer not null, nx_component_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, position integer not null, autostart_flag smallint not null, name varchar(64) not null, description varchar(64), primary key (nx_service_id));
...
create table nx_service_param (nx_service_param_id integer not null, nx_service_id integer not null, created_date timestamp not null, modified_date timestamp not null, modified_nx_user_id integer not null, param_name varchar(64) not null, param_label varchar(64), param_value varchar(1024), sequence_number integer, primary key (nx_service_param_id));
